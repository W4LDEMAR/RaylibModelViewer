...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        */
        ...
        modelRotateAngle += 25 * GetFrameTime();
        rlRotatef(modelRotateAngle, 0, 1, 0);
